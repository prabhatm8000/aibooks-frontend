                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 justify-center">
                        ...
                        <div className="space-y-1 sm:col-span-2 w-full flex items-center justify-center">
                            <TypographySmall className="text-center" isMuted>
                                ...
                                generated by AI. While we strive to provide
                                engaging and imaginative stories, please note
                                that the content is entirely machine-created and
                                may not reflect human perspectives, accuracy, or
                                cultural nuances.
                            </TypographySmall>
                        </div>
                    </div>
